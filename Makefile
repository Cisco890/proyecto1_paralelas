...
SRC := main.cpp src/bird.cpp src/tree.cpp src/flower.cpp src/season.cpp src/flying_animal.cpp src/weather.cpp src/grass.cpp src/cloud.cpp src/tulip.cpp src/celestial_body.cpp
OBJ := $(SRC:.cpp=.o)
BIN := screensaver
